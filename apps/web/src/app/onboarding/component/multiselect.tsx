...
interface MultipleSelectorProps {
  ...
  >;
  /** Called when the options list is scrolled near the end. */
  onListReachEnd?: () => void;
  /** Distance in pixels from the bottom to trigger `onListReachEnd`. */
...
const MultipleSelector = ({
  ...
  const [hasReachedListEnd, setHasReachedListEnd] = React.useState(false);
  ...
  const handleListScroll = React.useCallback(
    (event: React.UIEvent<HTMLDivElement>) => {
      ...
      if (distanceToBottom <= listEndOffset) {
        setHasReachedListEnd((alreadyReached) => {
          if (!alreadyReached) {
            onListReachEnd();
          }
          return true;
  ...
  }, [hasReachedListEnd, listEndOffset, onListReachEnd, open]);
        ...
        >
          {open && (
            <CommandList
              ...
              onScroll={onListReachEnd ? handleListScroll : undefined}
              onMouseLeave={() => {
